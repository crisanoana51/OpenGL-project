...
bool initOpenGLWindow()
{
	...
	//skybox
	faces.push_back("textures/criminal-element/criminal-element_rt.tga");
	faces.push_back("textures/criminal-element/criminal-element_lf.tga");
	faces.push_back("textures/criminal-element/criminal-element_up.tga");
	faces.push_back("textures/criminal-element/criminal-element_dn.tga");
	faces.push_back("textures/criminal-element/criminal-element_bk.tga");
	faces.push_back("textures/criminal-element/criminal-element_ft.tga");
...
void initObjects() {
	...
	//leaf.LoadModel("objects/leaf/leaf.obj");
...
//	leafGroundShader.loadShader("shaders/leafGroundShader.vert", "shaders/leafGroundShader.frag");
	//leafGroundShader.useShaderProgram();
